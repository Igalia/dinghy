...
gboolean
dy_handle_web_view_web_process_terminated (WebKitWebView                     *web_view,
...
gboolean
dy_handle_web_view_web_process_terminated_exit (WebKitWebView                     *web_view,
                                                WebKitWebProcessTerminationReason  reason,
                                                void                              *userdata)
{
                                   ...
                                   struct RestartData                *restart)
{
    ...
    if (++restart->tries >= restart->max_tries) {
        ...
        return dy_handle_web_view_web_process_terminated (web_view, reason, NULL);
    }
...
gulong
dy_web_view_connect_web_process_terminated_restart_handler (WebKitWebView *web_view,
                                                            unsigned       max_tries,
                                                            unsigned       try_window_ms)
{
...
dy_web_view_connect_default_error_handlers (WebKitWebView *web_view)
{
    static const struct {
        ...
        { "web-process-terminated",
            dy_handle_web_view_web_process_terminated },
    };
